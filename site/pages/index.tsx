...
const Home: NextPage = (props: any) => {
  ...
  return (
    <Layout title='Homepage'>
      <div className='mt-24 max-w-7xl mx-auto px-8 mt-8 mb-32 text-slate-800'>
        <div className='grid grid-cols-6 max-h-max'>
          <div className='mt-10 sm:col-span-4 col-span-6 mr-16 '>
            ...
            <h2 className='max-w-fit mx-auto text-6xl text-slate-800 font-bold left-0 drop-shadow-2xl'>
          ...
          <div className='h-96  w-96  border-slate-700 border-2 drop-shadow-2xl'>
        ...
        <div className='mt-16'>
          ...
          <div className='grid sm:grid-cols-3 gap-8 '>
            {props.data.map((item: any, key: any) => {
              return (
                <div className='border-2 border-slate-600 bg-white p-4 px-6 w-11/12 h-full drop-shadow-2xl' key={key}>
        ...
        <div className='mt-16'>
          ...
          <div className='grid sm:grid-cols-3 gap-8'>
            {props.journals.slice(0, 3).map((item: any, key: any) => {
              ...
              return (
                <div className='border-2 border-slate-600 bg-gray-200 p-4 px-6 w-11/12 h-full drop-shadow-2xl' key={key}>
